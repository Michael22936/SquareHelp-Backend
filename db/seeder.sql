...
insert into users (username, password, email, state, city, dob, phone_number, date_created, last_login, gender) values ('admin', 'password', 'mwoolfall0@harvard.edu', 'TX', 'San Antonio', 19321, '15266697883', 19321, '19321', 'F');
