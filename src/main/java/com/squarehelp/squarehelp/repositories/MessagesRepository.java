...
public interface MessagesRepository extends JpaRepository<Messages, Long> {
    ...
    @Query(value = "select id, author_user_id, recipient_user_id, message, user_id, last_updated, recipient_username FROM messages where author_user_id = :id", nativeQuery = true)
