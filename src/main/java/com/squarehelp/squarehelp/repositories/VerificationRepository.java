...
//    for current user sending veri forms



//    @Query(value = "SELECT id, originator_user_id, approver_user_id, day_created, days_smoke_free, is_approved FROM verifications_req WHERE originator_user_id = :id AND is_viewed = false;", nativeQuery = true)
