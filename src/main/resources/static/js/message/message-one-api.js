...
const outHTML = () => {
    ...
    data.map((e) => {
        if (e.author_user_id == author) html += "<p class='messageText messageThem bg-info'><span class='messageConvoItem dates'>" + e.last_updated + "</span><img src='" + authorPic + "' class='messageConvoItem messageProfilePic'><span class='messageConvoItem'>" + authorName + ":</span><span class='messageConvoItem'>" + e.message + "</span></p>";
